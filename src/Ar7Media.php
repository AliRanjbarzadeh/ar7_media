...
use Ar7\Media\Facades\Ar7Media as Ar7MediaFacade;

trait Ar7Media
{
	public function media()
	{
		return $this->morphToMany(Ar7MediaFacade::medium_model(), 'media_item', 'medium_items', 'media_item_id', 'medium_id')->withPivot('name');
	}
